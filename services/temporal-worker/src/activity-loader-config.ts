...
export function createActivityLoaderConfig(): ActivityLoaderConfig {
  return {
    database: {
      ...
      database: process.env.DATABASE_NAME || 'temporal_workflows',
      user: process.env.DATABASE_USER || 'temporal_user',
      password: process.env.DATABASE_PASSWORD || 'temporal_password',
